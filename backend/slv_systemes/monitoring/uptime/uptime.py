...
def start(uptime_path="uptime.json"):
    ...
    print(f"Différence en secondes : {difference.total_seconds()}")
    data["down_total_s"] += difference.total_seconds()
    ...
    while True:
        ...
        total_time_s = data["up_total_s"] + data["down_total_s"]
        uptime_percent = (data["up_total_s"] / total_time_s) * 100
        data["up_time_percent"] = round(uptime_percent, 1)
